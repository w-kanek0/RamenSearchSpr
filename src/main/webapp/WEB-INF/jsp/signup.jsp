...
<div class="container w-50">
	<div class="card">
		...
		<div class="card-body">
			<f:form action="RegisterUser" ModelAttribute="RegisterUserForm" name="form" method="POST">
				<table class="table">
					<tr>
				...
				<div class="text-center">
					...
					<a href="${pageContext.request.contextPath}/" class="btn btn-secondary mb-2">　戻る　</a>
				</div>
			</f:form>
		</div>
	</div>
